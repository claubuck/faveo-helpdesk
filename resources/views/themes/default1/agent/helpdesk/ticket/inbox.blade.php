...
if (Auth::user()->role == 'agent') {
    ...
    $tickets = App\Model\helpdesk\Ticket\Tickets::whereIn('status', [1, 7, 8])->where('dept_id', '=', $dept->id)->orderBy('id', 'DESC')->count();
} else {
    $tickets = App\Model\helpdesk\Ticket\Tickets::whereIn('status', [1, 7, 8])->orderBy('id', 'DESC')->count();
}
?>
<!-- Main content -->
