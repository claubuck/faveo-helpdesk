...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        NotificationType::create(['id' => '3', 'message' => 'Se ha creado un nuevo ticket', 'type' => 'new_ticket', 'icon_class' => 'fa fa-envelope']);
        ...
        /* Ticket status */
        Ticket_status::create(['name' => 'Open', 'state' => 'open', 'mode' => '3', 'message' => 'El Ticket ha sido reabierto por', 'flags' => '0', 'sort' => '1', 'properties' => 'Open tickets.']);
        Ticket_status::create(['name' => 'Resolved', 'state' => 'closed', 'mode' => '1', 'message' => 'El Ticket ha sido resuelto por', 'flags' => '0', 'sort' => '2', 'properties' => 'Resolved tickets.']);
        Ticket_status::create(['name' => 'Closed', 'state' => 'closed', 'mode' => '3', 'message' => 'El Ticket ha sido cerrado por', 'flags' => '0', 'sort' => '3', 'properties' => 'Closed tickets. Tickets will still be accessible on client and staff panels.']);
        Ticket_status::create(['name' => 'Archived', 'state' => 'archived', 'mode' => '3', 'message' => 'El Ticket ha sido archivado por', 'flags' => '0', 'sort' => '4', 'properties' => 'Tickets only adminstratively available but no longer accessible on ticket queues and client panel.']);
        Ticket_status::create(['name' => 'Deleted', 'state' => 'deleted', 'mode' => '3', 'message' => 'El Ticket ha sido eliminado por', 'flags' => '0', 'sort' => '5', 'properties' => 'Tickets queued for deletion. Not accessible on ticket queues.']);
        Ticket_status::create(['name' => 'Unverified', 'state' => 'unverified', 'mode' => '3', 'message' => 'Verificación de cuenta de usuario requerida.', 'flags' => '0', 'sort' => '6', 'properties' => 'Ticket will be open after user verifies his/her account.']);
        Ticket_status::create(['name' => 'Request Approval', 'state' => 'unverified', 'mode' => '3', 'message' => 'Solicitud de aprobación por', 'flags' => '0', 'sort' => '7', 'properties' => 'Ticket will be approve  after Admin verifies  this ticket']);
...
//        Widgets::create(['id' => '6', 'name' => 'side2']);
        ...
        Template::create(['id' => '1', 'variable' => '0', 'name' => 'Esta plantilla es para enviar aviso al agente cuando se le asigna un ticket', 'type' => '1', 'message' => '<div>Hola {!!$ticket_agent_name!!},<br /><br /><b>Ticket No:</b> {!!$ticket_number!!}<br />Ha sido asignado a usted por {!!$ticket_assigner!!} <br/> Por favor revise y responda el ticket.<br /> Enlace: {!!$ticket_link!!}<br /><br />Gracias<br />Saludos cordiales,<br /> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '2', 'variable' => '1', 'name' => 'Esta plantilla es para enviar aviso al cliente con enlace del ticket para revisar ticket sin iniciar sesión', 'type' => '2', 'subject' => 'Consulte su Ticket', 'message' => '<div>Hola {!!$user!!},<br/><br/>Haga clic en el enlace de abajo para ver su ticket solicitado<br/> {!!$ticket_link_with_number!!}<br/><br/>Saludos cordiales,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '3', 'variable' => '0', 'name' => 'Esta plantilla es para enviar aviso al cliente cuando el estado del ticket cambia a cerrado', 'type' => '3', 'message' => '<div>Hola,<br/><br/>Este mensaje es referente a su ticket ID {!!$ticket_number!!}. Estamos cambiando el estado de este ticket a "Cerrado" ya que el problema parece haber sido resuelto.<br/><br/>Gracias<br/>Saludos cordiales,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '4', 'variable' => '0', 'name' => 'Esta plantilla es para enviar aviso al cliente sobre creación exitosa de ticket', 'type' => '4', 'message' => '<div><span>Hola {!!$user!!}<br/><br/></span><span>Gracias por contactarnos. Esta es una respuesta automática confirmando la recepción de su ticket. Nuestro equipo le responderá lo antes posible. Al responder, por favor asegúrese de mantener el ID del ticket en el asunto para que podamos rastrear sus respuestas.<br/><br/></span><span><b>ID del Ticket:</b> {!!$ticket_number!!} <br/><br/></span><span> {!!$department_sign!!}<br/></span>Puede consultar el estado o actualizar este ticket en línea en: {!!$system_link!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '5', 'variable' => '0', 'name' => 'Esta plantilla es para enviar aviso al agente sobre creación de nuevo ticket', 'type' => '5', 'message' => '<div>Hola {!!$ticket_agent_name!!},<br/><br/>Nuevo ticket {!!$ticket_number!!} creado <br/><br/><b>De</b><br/><b>Nombre:</b> {!!$ticket_client_name!!}   <br/><b>Correo:</b> {!!$ticket_client_email!!}<br/><br/> {!!$content!!}<br/><br/>Saludos cordiales,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '6', 'variable' => '0', 'name' => 'Esta plantilla es para enviar aviso al cliente sobre nuevo ticket creado por agente a nombre del cliente', 'type' => '6', 'message' => '<div> {!!$content!!}<br><br> {!!$agent_sign!!}<br><br>Puede consultar el estado o actualizar este ticket en línea en: {!!$system_link!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '7', 'variable' => '1', 'name' => 'Esta plantilla es para enviar aviso al cliente sobre nuevo registro durante la creación de ticket para clientes no registrados', 'type' => '7', 'subject' => 'Confirmación de Registro', 'message' => '<p>Hola {!!$user!!}, </p><p>Este correo es la confirmación de que ahora está registrado en nuestro sistema de soporte.</p><p><b>Correo Registrado:</b> {!!$email_address!!}</p><p><b>Contraseña:</b> {!!$user_password!!}</p><p>Puede visitar el sistema de soporte para consultar artículos y contactarnos en cualquier momento: {!!$system_link!!}</p><p>Gracias.</p><p>Saludos cordiales,</p><p> {!!$system_from!!} </p>', 'set_id' => '1']);
        Template::create(['id' => '8', 'variable' => '1', 'name' => 'Esta plantilla es para enviar aviso a cualquier usuario sobre la opción de restablecer contraseña', 'type' => '8', 'subject' => 'Restablecer su Contraseña', 'message' => 'Hola {!!$user!!},<br/><br/>Solicitó restablecer su contraseña. Para hacerlo, por favor haga clic en este enlace:<br/><br/> {!!$password_reset_link!!}<br/><br/>Esto le permitirá cambiar su contraseña por una nueva. Si no solicitó esto, no se preocupe, mantendremos su contraseña segura.<br/><br/>Gracias.<br/><br/>Saludos cordiales,<br/> {!!$system_from!!}', 'set_id' => '1']);
        Template::create(['id' => '9', 'variable' => '0', 'name' => 'Esta plantilla es para enviar aviso al cliente cuando se hace una respuesta a su ticket', 'type' => '9', 'message' => '<span></span><div><span></span><p> {!!$content!!}<br/></p><p> {!!$agent_sign!!} </p><p><b>Detalles del Ticket</b></p><p><b>ID del Ticket:</b> {!!$ticket_number!!}</p></div>', 'set_id' => '1']);
        Template::create(['id' => '10', 'variable' => '0', 'name' => 'Esta plantilla es para enviar aviso al agente cuando el cliente hace una respuesta al ticket', 'type' => '10', 'message' => '<div>Hola {!!$ticket_agent_name!!},<br/><b><br/></b>Se ha hecho una respuesta al ticket {!!$ticket_number!!}<br/><b><br/></b><b>De<br/></b><b>Nombre: </b>{!!$ticket_client_name!!}<br/><b>Correo: </b>{!!$ticket_client_email!!}<br/><b><br/></b> {!!$content!!}<br/><b><br/></b>Saludos cordiales,<br/> {!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '11', 'variable' => '1', 'name' => 'Esta plantilla es para enviar aviso al cliente sobre enlace de confirmación de registro', 'type' => '11', 'subject' => 'Verifique su dirección de correo electrónico', 'message' => '<p>Hola {!!$user!!}, </p><p>Este correo es la confirmación de que ahora está registrado en nuestro sistema de soporte.</p><p><b>Correo Registrado:</b> {!!$email_address!!}</p><p>Por favor haga clic en el enlace de abajo para activar su cuenta e iniciar sesión en el sistema {!!$password_reset_link!!}</p><p>Gracias.</p><p>Saludos cordiales,</p><p> {!!$system_from!!} </p>', 'set_id' => '1']);
        Template::create(['id' => '12', 'variable' => '1', 'name' => 'Esta plantilla es para enviar aviso al equipo cuando un ticket es asignado al equipo', 'type' => '12', 'message' => '<div>Hola {!!$ticket_agent_name!!},<br /><br /><b>Ticket No:</b> {!!$ticket_number!!}<br />Ha sido asignado a su equipo : {!!$team!!} por {!!$ticket_assigner!!} <br /><br />Gracias<br />Saludos cordiales,<br />{!!$system_from!!}</div>', 'set_id' => '1']);
        Template::create(['id' => '13', 'variable' => '1', 'name' => 'Esta plantilla es para enviar aviso al cliente cuando se cambia la contraseña', 'type' => '13', 'subject' => 'Cambio de Contraseña', 'message' => 'Hola {!!$user!!},<br /><br />Su contraseña ha sido cambiada exitosamente. Su nueva contraseña es: {!!$user_password!!}<br /><br />Gracias.<br /><br />Saludos cordiales,<br /> {!!$system_from!!}', 'set_id' => '1']);
        Template::create(['id' => '14', 'variable' => '1', 'name' => 'Esta plantilla es para notificar a los usuarios cuando sus tickets han sido fusionados', 'type' => '14', 'subject' => 'Sus tickets han sido fusionados', 'message' => '<p>Hola {!!$user!!},<br />&nbsp;</p><p>Su(s) ticket(s) con número {!!$merged_ticket_numbers!!} han sido cerrados y&nbsp;fusionados con <a href="{!!$ticket_link!!}">{!!$ticket_number!!}</a>.&nbsp;</p><p>Posibles razones para fusionar tickets:</p><ul><li>Los tickets están duplicados</li><li>Los tickets indican&nbsp;el mismo problema</li><li>Otro miembro de su organización ha creado un ticket para el mismo problema</li></ul><p><a href="{!!$system_link!!}">Haga clic aquí</a> para iniciar sesión en su cuenta y revisar sus tickets.</p><p>Saludos,</p><p>{!!$system_from!!}</p>', 'set_id' => '1']);
         ...
         * Ratings
         */
        Rating::create(['id' => '1', 'name' => 'Satisfacción General', 'display_order' => '1', 'allow_modification' => '1', 'rating_scale' => '5', 'rating_area' => 'Área de Mesa de Ayuda']);
        Rating::create(['id' => '2', 'name' => 'Calificación de Respuesta', 'display_order' => '1', 'allow_modification' => '1', 'rating_scale' => '5', 'rating_area' => 'Área de Comentarios']);
